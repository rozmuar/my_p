          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
                  ...
                  <span>До 5 коллекций</span>
                </li>
                <li className="flex items-center">
                  <Check className="w-5 h-5 text-green-500 mr-3" />
                  <span>Базовая генерация кода</span>
                </li>
                <li className="flex items-center">
                  <Check className="w-5 h-5 text-green-500 mr-3" />
            ...
            <div className="bg-gradient-to-br from-blue-600 to-purple-600 p-8 rounded-2xl shadow-xl text-white relative">
              ...
              <div className="text-4xl font-bold mb-6">
                ₽990 <span className="text-lg opacity-80">/месяц</span>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
                  <Check className="w-5 h-5 text-white mr-3" />
                  <span>Неограниченные коллекции</span>
                </li>
                <li className="flex items-center">
                  <Check className="w-5 h-5 text-white mr-3" />
                  <span>Полная генерация кода</span>
                </li>
                <li className="flex items-center">
                  <Check className="w-5 h-5 text-white mr-3" />
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <div className="text-4xl font-bold text-gray-900 mb-6">
                ₽2990 <span className="text-lg text-gray-500">/месяц</span>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
                  <Check className="w-5 h-5 text-green-500 mr-3" />
                ...
                <li className="flex items-center">
                  <Check className="w-5 h-5 text-green-500 mr-3" />
                  <span>Корпоративная поддержка</span>
                </li>
                <li className="flex items-center">
                  <Check className="w-5 h-5 text-green-500 mr-3" />
                  <span>Белая маркировка</span>
                </li>
              </ul>
